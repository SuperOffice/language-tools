// This file is for backup and reference. The code is not currently used.
// It contains previous attempts at implementing the language plugin for SuperOffice files.
// The current implementation can be found in the 'languagePlugin.ts' file.
...
//         textDocument = this.editedTextDocument.replace(includeRegex, '//..............');
...
//     private * generateIncludes(): Generator<VirtualCode> {
...
//             if (match[0]) {
//                 yield {
//                     id: 'import_' + counter++ + '_' + match[0].length,
//                     languageId: 'typescript',
//                     snapshot: {
//                         getText: (start, end) => 'const x = 1; consts y = 1;',
//                         getLength: () => match ? match[0].length : 0,
//                         getChangeRange: () => undefined,
//                     },
//                     mappings: [{
//                         sourceOffsets: [match.index],
//                         generatedOffsets: [0],
//                         lengths: [match.index + match[0].length],
//                         data: {
//                             completion: true,
//                             format: true,
//                             navigation: true,
